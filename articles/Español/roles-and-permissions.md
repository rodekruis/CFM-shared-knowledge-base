...
Documentar los roles y permisos de los usuarios es esencial para garantizar claridad, seguridad y responsabilidad dentro de la Plataforma Regional de Gestión de Retroalimentación de Datos. Ayudará a comprender quién puede acceder, modificar o gestionar secciones específicas de la plataforma y sus datos. Y reducirá el riesgo de configuraciones incorrectas, accesos no autorizados y errores operativos. También facilita la incorporación, la auditoría y el cumplimiento normativo, al ofrecer una referencia confiable sobre el funcionamiento del sistema. 
...
Este rol está designado para el punto focal de Participación Comunitaria y Rendición de Cuentas (CEA) de la SN en la sede central. Esta persona supervisará, monitoreará y gestionará la retroalimentación recibida y proporcionada a la comunidad. Es la principal persona de contacto para la SN en caso de cualquier problema con la plataforma.
...
- Crear o eliminar usuarios mediante la entidad "solicitud de acceso de usuario"
- Asignar usuarios para dar seguimiento a registros específicos de retroalimentación
- Dar seguimiento en el stream (muro de actividad) con otros compañeros
- Leer informes
- Autorizado(a) para acceder a registros de retroalimentación sensibles
  - Puede leer, editar, asignar usuarios y dar seguimiento a retroalimentación sensible

#### Punto Focal de Retroalimentación

Este rol está designado para miembros de la SN (p. ej., CEA, Planificación, Seguimiento, Monitoreo y Evaluación (PMER), Information Management (IM), sucursales, operadores de línea directa) que gestionarán la retroalimentación ingresada en la Plataforma Regional de Gestión de Retroalimentación. 
...
- Dar seguimiento en el stream con otros compañeros
- Leer informes


#### Gestor de Retroalimentación

Este rol está designado para miembros de la SN (p. ej., puntos focales de Asistencia en Efectivo y Cupones (CVA), Salud, Refugio) que gestionarán o simplemente verán retroalimentación específica.
...
- Acceso de alto nivel a registros de retroalimentación sin Información de Identificación Personal
